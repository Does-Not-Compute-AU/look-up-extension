...
export default function SwitchButton({ enabled, setEnabled }: Props) {
    return (
        <Switch
            checked={enabled}
            onChange={setEnabled}
            className={clsx(
                enabled ? 'bg-up-orange' : 'bg-gray-200',
        ...
        >
            ...
            >
                ...
                <span
                    ...
                    aria-hidden="true"
                >
                    <svg className="h-3 w-3 text-[#ff7a64]" fill="currentColor" viewBox="0 0 12 12">
